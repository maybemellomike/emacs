...
#+BEGIN_SRC emacs-lisp
  ...
  (menu-bar-mode -1)
  (scroll-bar-mode -1)
;; scroll one line at a time rather than jumping half a page
(setq scroll-step 1)
(setq scroll-conservatively 101)  ;; any value > 100 means "never jump"
;; keep 5 lines visible above/below the cursor at all times (scrolloff)
...
(use-package doom-modeline
  ...
  (doom-modeline-major-mode-icon nil)   ;; no major mode icon
  (doom-modeline-height 25)             ;; slightly taller than default
  (doom-modeline-bar-width 3)           ;; left accent bar width
